...
class NgwPostController extends AbstractController
{
    ...
    public function __construct(
        ...
        $this->response->headers->setCookie(new Cookie('psp-id', $this->cookieKey));
    }
    ...
    public function execute(Request $request)
    {
        if($request->getMethod() === "POST"){
            $order = new Order();
            $address = new Address();
            $this->requestToOrderMapper->mapRequestToOrder($request, $order, $address);
